...
pickle_in = open('https://raw.githubusercontent.com/Seb-Dupont-DataAnalyst/Project_Week6/sklearn_mlp_model.pkl', 'rb')
mlp_model = pickle.load(pickle_in) 

pickle_count_vect = open('https://raw.githubusercontent.com/Seb-Dupont-DataAnalyst/Project_Week6/count_vect_only.pkl', 'rb')
